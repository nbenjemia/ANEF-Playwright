...
//})();
  ...
  await page.locator('xpath=/html/body/div/div/main/div[1]/form/div[1]/div/input').fill('7703055101')
  //(user.NumEtrangerVisa);
  await page.locator('xpath=/html/body/div/div/main/div[1]/form/div[2]/input').fill('HHizaoui001!')
  //(user.PWEtrangerVisa);
...
await page.locator('xpath=/html/body/app-root/div/app-portal/main/app-theme-v2/div/app-demande/div/div[3]/app-justificatifs/div[2]/div/p-accordion/div/p-accordiontab[1]/div[2]/div/div[1]/div/app-pieces-jointes[1]/div/span[1]/input').setInputFiles('C:/Users/hhizaoui/Documents/PlayWrigth Katalon/Playwright-main/Data Files/TitreDeSejour.pdf');
await page.waitForTimeout(5000);

//  veuillez fournir le recto et le verso de votre Passeport en cours de validité
await page.locator('xpath=/html/body/app-root/div/app-portal/main/app-theme-v2/div/app-demande/div/div[3]/app-justificatifs/div[2]/div/p-accordion/div/p-accordiontab[1]/div[2]/div/div[1]/div/app-pieces-jointes[2]/div/span[1]/input').setInputFiles('C:/Users/hhizaoui/Documents/PlayWrigth Katalon/Playwright-main/Data Files/Passeport.pdf');
await page.waitForTimeout(5000);
...
await page.locator('xpath=/html/body/app-root/div/app-portal/main/app-theme-v2/div/app-demande/div/div[3]/app-justificatifs/div[2]/div/p-accordion/div/p-accordiontab[1]/div[2]/div/div[2]/div/app-pieces-jointes/div/span[1]/input').setInputFiles('C:/Users/hhizaoui/Documents/PlayWrigth Katalon/Playwright-main/Data Files/JustificatifDomicileDeMoinsDe6Mois.pdf');
await page.waitForTimeout(5000);

//  veuillez fournir Certificat d'inscription ou justificatif de préinscription
await page.locator('xpath=/html/body/app-root/div/app-portal/main/app-theme-v2/div/app-demande/div/div[3]/app-justificatifs/div[2]/div/p-accordion/div/p-accordiontab[2]/div[2]/div/app-pieces-jointes[1]/div/span[1]/input').setInputFiles('C:/Users/hhizaoui/Documents/PlayWrigth Katalon/Playwright-main/Data Files/TitreDeSejour.pdf');
await page.waitForTimeout(5000);

//  veuillez fournir le Relevé de notes
await page.locator('xpath=/html/body/app-root/div/app-portal/main/app-theme-v2/div/app-demande/div/div[3]/app-justificatifs/div[2]/div/p-accordion/div/p-accordiontab[2]/div[2]/div/app-pieces-jointes[2]/div/span[1]/input').setInputFiles('C:/Users/hhizaoui/Documents/PlayWrigth Katalon/Playwright-main/Data Files/TitreDeSejour.pdf');
await page.waitForTimeout(5000);

//  veuillez fournir le Diplôme obtenu en France
await page.locator('xpath=/html/body/app-root/div/app-portal/main/app-theme-v2/div/app-demande/div/div[3]/app-justificatifs/div[2]/div/p-accordion/div/p-accordiontab[2]/div[2]/div/app-pieces-jointes[3]/div/span[1]/input').setInputFiles('C:/Users/hhizaoui/Documents/PlayWrigth Katalon/Playwright-main/Data Files/TitreDeSejour.pdf');
await page.waitForTimeout(5000);

//  veuillez fournir Attestation de réussite
await page.locator('xpath=/html/body/app-root/div/app-portal/main/app-theme-v2/div/app-demande/div/div[3]/app-justificatifs/div[2]/div/p-accordion/div/p-accordiontab[2]/div[2]/div/app-pieces-jointes[4]/div/span[1]/input').setInputFiles('C:/Users/hhizaoui/Documents/PlayWrigth Katalon/Playwright-main/Data Files/TitreDeSejour.pdf');
await page.waitForTimeout(5000);

//  veuillez fournir Vous êtes pris en charge par un tiers
await page.locator('xpath=/html/body/app-root/div/app-portal/main/app-theme-v2/div/app-demande/div/div[3]/app-justificatifs/div[2]/div/p-accordion/div/p-accordiontab[3]/div[2]/div/div[2]/app-pieces-jointes[1]/div/span[1]/input').setInputFiles('C:/Users/hhizaoui/Documents/PlayWrigth Katalon/Playwright-main/Data Files/TitreDeSejour.pdf');
await page.waitForTimeout(5000);

//  veuillez fournir Vous êtes boursier
await page.locator('xpath=/html/body/app-root/div/app-portal/main/app-theme-v2/div/app-demande/div/div[3]/app-justificatifs/div[2]/div/p-accordion/div/p-accordiontab[3]/div[2]/div/div[2]/app-pieces-jointes[2]/div/span[1]/input').setInputFiles('C:/Users/hhizaoui/Documents/PlayWrigth Katalon/Playwright-main/Data Files/TitreDeSejour.pdf');
await page.waitForTimeout(5000);

//  veuillez fournir Vous êtes salarié
await page.locator('xpath=/html/body/app-root/div/app-portal/main/app-theme-v2/div/app-demande/div/div[3]/app-justificatifs/div[2]/div/p-accordion/div/p-accordiontab[3]/div[2]/div/div[2]/app-pieces-jointes[3]/div/span[1]/input').setInputFiles('C:/Users/hhizaoui/Documents/PlayWrigth Katalon/Playwright-main/Data Files/TitreDeSejour.pdf');
await page.waitForTimeout(5000);

//  veuillez fournir Vous disposez de ressources suffisantes
await page.locator('xpath=/html/body/app-root/div/app-portal/main/app-theme-v2/div/app-demande/div/div[3]/app-justificatifs/div[2]/div/p-accordion/div/p-accordiontab[3]/div[2]/div/div[2]/app-pieces-jointes[4]/div/span[1]/input').setInputFiles('C:/Users/hhizaoui/Documents/PlayWrigth Katalon/Playwright-main/Data Files/TitreDeSejour.pdf');
await page.waitForTimeout(5000);
...
//Valider et transmettre ma demande >>
//await page.locator ('xpath=/html/body/app-root/div/app-portal/main/app-theme-v2/div/app-demande/div/div[3]/app-actions-bar/div/div[2]/div/div[2]/button/span').click ();
console.log("\n================ Devtools: Perfermance.getMetrics   =========\n")
...
//})();
  ...
  await page.locator('xpath=/html/body/app-root/div/app-root/main/app-registration/div/div[1]/p-button/button/span[2]').click();
  // Text input login PW
  await page.locator('xpath=/html/body/div/div/main/div[1]/form/div[1]/div/input').fill('7703055116')
  //(user.NumEtrangerVisa);
  await page.locator('xpath=/html/body/div/div/main/div[1]/form/div[2]/input').fill('HHizaoui001!')
  //(user.PWEtrangerVisa);
  await page.locator('xpath=/html/body/div/div/main/div[1]/form/button').click();
